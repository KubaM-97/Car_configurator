...
class RimColor extends Component {
    constructor(){
        ...
        this.state = {
            rimsColor: [
                {id: uniqid(), img: rimBlack, name: "Black", price: 300},
                {id: uniqid(), img: rimGreen, name: "Green", price: 300},
                {id: uniqid(), img: rimPink, name: "Pink", price: 300}
            ],
    ...
    render(){
        const items = this.state.rimsColor.map(el => {
            return <Item key={el.id} id={el.id} img={el.img} name={el.name} price={el.price} inputNameAttr="rimColor" category="Rim Color" 
